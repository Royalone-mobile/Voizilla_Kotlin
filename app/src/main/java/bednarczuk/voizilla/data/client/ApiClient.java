package bednarczuk.voizilla.data.client;
...
import bednarczuk.voizilla.BuildConfig;
import bednarczuk.voizilla.data.client.auth.ApiKeyAuth;
import bednarczuk.voizilla.data.client.auth.HttpBasicAuth;
import bednarczuk.voizilla.data.client.auth.OAuth;
...
public class ApiClient {
    ...
    public void createDefaultAdapter() {
        ...
        String baseUrl = "https://dev.vozilla.pl/api-client-mobile/";
        if (!baseUrl.endsWith("/"))
            baseUrl = baseUrl + "/";
